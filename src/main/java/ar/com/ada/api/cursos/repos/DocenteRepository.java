...
public interface DocenteRepository extends JpaRepository<Docente, Integer> {
    ...
    @Query("select CASE WHEN count(d) > 0 THEN true ELSE false END from Docente d where d.paisId=:pais and d.tipoDocuEnum=:tipoDocuEnum and d.documento=:documento")
